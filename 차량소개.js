var now_brand = 'KIA'; // KIA, 현대, 르노코리아, KG, 쉐보레

function change_brand(brand, button) {
        now_brand = brand;

        // 열려있는 모든 자세히 보기 창, 리뷰 창 닫기
        ...
        var reviewElements = document.getElementsByClassName('reviews');
        ...
        // 이미지를 brand의 소형 size 이미지로 바꾸기
        var imageElements = document.getElementsByClassName('carImage');
        var carNameElements = document.getElementsByClassName('car_name');
        var contentElements = document.getElementsByClassName('content');
        var best_carElements = document.getElementsByClassName('best_car');
        ...
        for (let i = 0; i < best_carElements.length; i++) {
                best_carElements[i].style.display = 'none';
        }

        switch (brand) {
            case 'KIA':
                contentElements[0].style.display = 'block'; //소형
                contentElements[1].style.display = 'none';  // 준중형
                contentElements[2].style.display = 'block'; // 중형
                contentElements[3].style.display = 'block'; // 준대형
                contentElements[4].style.display = 'block'; // 대형

                contentElements[1].style.paddingLeft = '260px';
                contentElements[2].style.paddingLeft = '260px';
                contentElements[3].style.paddingLeft = '260px';
                contentElements[4].style.paddingLeft = '260px';


                //소형
                best_carElements[0].style.display = 'block';
                best_carElements[1].style.display = 'block';
                best_carElements[2].style.display = 'block';
                best_carElements[3].style.display = 'none';


                // 준중형
                best_carElements[4].style.display = 'none';
                best_carElements[5].style.display = 'none';
                best_carElements[6].style.display = 'none';
                best_carElements[7].style.display = 'none';


                // 중형
                best_carElements[8].style.display = 'block';
                best_carElements[9].style.display = 'block';

                //준대형
                best_carElements[10].style.display = 'block';
                best_carElements[11].style.display = 'block';
                best_carElements[12].style.display = 'none';
                best_carElements[13].style.display = 'none';



                //대형
                best_carElements[14].style.display = 'block';
                best_carElements[15].style.display = 'none';
                ...
                // 이미지 바꾸기
                //소형
                imageElements[0].src = "이미지/2페이지/기아/니로EV 2.png";
                imageElements[1].src = "이미지/2페이지/기아/니로 하이브리드 2.png";
                imageElements[2].src = "이미지/2페이지/기아/셀토스 2.png";

                carNameElements[0].textContent = "니로 EV";
                carNameElements[1].textContent = "니로 하이브리드";
                carNameElements[2].textContent = "셀토스";

                imageElements[0].alt = "니로EV 2";
                imageElements[1].alt = "니로 하이브리드 2";
                imageElements[2].alt = "셀토스 2";

                // 중형
                imageElements[8].src = "이미지/2페이지/차/K5 2.png";
                imageElements[9].src = "이미지/2페이지/기아/소렌토하이브리드 2.png";

                carNameElements[8].textContent = "K5";
                carNameElements[9].textContent = "소렌토 하이브리드";

                imageElements[8].alt = "K5 2";
                imageElements[9].alt = "소렌토하이브리드 2";
    

                // 준대형
                imageElements[10].src = "이미지/2페이지/기아/K8 2.png";
                imageElements[11].src = "이미지/2페이지/기아/모하비 2.png";

                carNameElements[10].textContent = "K8";
                carNameElements[11].textContent = "MOHAVE";

                imageElements[10].alt = "K8 2";
                imageElements[11].alt = "모하비 2";

                 // 대형
                imageElements[14].src = "이미지/2페이지/차/K9 2.png";

                carNameElements[14].textContent = "K9";

                imageElements[14].alt = "K9 2";
            ...
            case '현대':
                contentElements[0].style.display = 'block'; // 소형
                contentElements[1].style.display = 'block'; // 준중형
                contentElements[2].style.display = 'block'; // 중형
                contentElements[3].style.display = 'block'; // 준대형
                contentElements[4].style.display = 'block'; // 대형
                ...
                //소형
                best_carElements[0].style.display = 'block';
                best_carElements[1].style.display = 'none';
                best_carElements[2].style.display = 'none';
                best_carElements[3].style.display = 'none';


                // 준중형
                best_carElements[4].style.display = 'block';
                best_carElements[5].style.display = 'block';
                best_carElements[6].style.display = 'block';
                best_carElements[7].style.display = 'block';
                ...
                // 이미지 바꾸기
                // 소형
                imageElements[0].src = "이미지/2페이지/현대/코나 2.png";

                carNameElements[0].textContent = "코나";

                imageElements[0].alt = "코나 2";


                // 준중형
                imageElements[4].src = "이미지/2페이지/현대/아반떼 2.png";
                imageElements[5].src = "이미지/2페이지/현대/아반떼N 2.png";
                imageElements[6].src = "이미지/2페이지/현대/아이오닉 5N 2.png";
                imageElements[7].src = "이미지/2페이지/현대/투싼 2.png";

                carNameElements[4].textContent = "아반떼";
                carNameElements[5].textContent = "아반떼N";
                carNameElements[6].textContent = "아이오닉 5N";
                carNameElements[7].textContent = "투싼";

                imageElements[4].alt = "아반떼 2";
                imageElements[5].alt = "아반떼N 2";
                imageElements[6].alt = "아이오닉 5N 2";
                imageElements[7].alt = "투싼 2";


                 // 중형
                imageElements[8].src = "이미지/2페이지/현대/소나타 2.png";
                imageElements[9].src = "이미지/2페이지/현대/싼타페 2.png";

                carNameElements[8].textContent = "소나타";
                carNameElements[9].textContent = "싼타페";

                imageElements[8].alt = "소나타 2";
                imageElements[9].alt = "싼타페 2";


                // 준대형
                imageElements[10].src = "이미지/2페이지/현대/그랜저 2.png";
                imageElements[11].src = "이미지/2페이지/현대/팰리세이드 2.png";

                carNameElements[10].textContent = "그랜저";
                carNameElements[11].textContent = "팰리세이드";

                imageElements[10].alt = "그랜저 2";
                imageElements[11].alt = "팰리세이드 2";



                // 대형
                imageElements[14].src = "이미지/2페이지/현대/스타리아라운지 2.png";

                carNameElements[14].textContent = "스타리아 라운지";

                imageElements[14].alt = "스타리아라운지 2";
            ...
            case '르노코리아':
                ...
                contentElements[1].style.display = 'none';
                contentElements[2].style.display = 'block';
                contentElements[3].style.display = 'none';
                contentElements[4].style.display = 'none';
                ...
                //준대형
                best_carElements[10].style.display = 'none';
                best_carElements[11].style.display = 'none';
                best_carElements[12].style.display = 'none';
                best_carElements[13].style.display = 'none';


                //대형
                best_carElements[14].style.display = 'none';
                best_carElements[15].style.display = 'none';


                // 이미지 바꾸기
                //소형
                imageElements[0].src = "이미지/2페이지/르노코리아/XM3 2.png";
                imageElements[1].src = "이미지/2페이지/르노코리아/XM3 E TECH 2.png";

                carNameElements[0].textContent = "XM3";
                carNameElements[1].textContent = "XM3 E-TECH";

                imageElements[0].alt = "XM3 2";
                imageElements[1].alt = "XM3 E TECH 2";


                // 중형
                imageElements[8].src = "이미지/2페이지/르노코리아/SM6 2.png";
                imageElements[9].src = "이미지/2페이지/르노코리아/QM6 2.png";

                carNameElements[8].textContent = "SM6";
                carNameElements[9].textContent = "QM6";

                imageElements[8].alt = "SM6 2";
                imageElements[9].alt = "QM6 2";
            ...
            case 'KG':
                ...
                contentElements[2].style.display = 'block';
                contentElements[3].style.display = 'block';
                contentElements[4].style.display = 'none';

                contentElements[1].style.paddingLeft = '20px';
                contentElements[2].style.paddingLeft = '260px';
                contentElements[3].style.paddingLeft = '260px';
                contentElements[4].style.paddingLeft = '260px';

                //소형
                best_carElements[0].style.display = 'none';
                best_carElements[1].style.display = 'none';
                best_carElements[2].style.display = 'none';
                best_carElements[3].style.display = 'none';
                ...
                best_carElements[10].style.display = 'block';
                best_carElements[11].style.display = 'block';
                best_carElements[12].style.display = 'block';
                best_carElements[13].style.display = 'none';
                ...
                // 이미지 바꾸기
                //준중형
                imageElements[4].src = "이미지/2페이지/KG/코란도 2.png";

                carNameElements[4].textContent = "코란도";

                imageElements[4].alt = "코란도 2";


                // 중형
                imageElements[8].src = "이미지/2페이지/KG/토레스 2.png";
                imageElements[9].src = "이미지/2페이지/KG/토레스 EV X 2.png";

                carNameElements[8].textContent = "토레스";
                carNameElements[9].textContent = "토레스 EVX";

                imageElements[8].alt = "토레스 2";
                imageElements[9].alt = "토레스 EV X 2";


                // 준대형
                imageElements[10].src = "이미지/2페이지/KG/렉스턴 2.png";
                imageElements[11].src = "이미지/2페이지/KG/렉스턴스포츠 2.png";
                imageElements[12].src = "이미지/2페이지/KG/칸 2.png";

                carNameElements[10].textContent = "렉스턴";
                carNameElements[11].textContent = "렉스턴 스포츠";
                carNameElements[12].textContent = "렉스터 스포츠 칸";

                imageElements[10].alt = "렉스턴 2";
                imageElements[11].alt = "렉스턴스포츠 2";
                imageElements[12].alt = "칸 2";
            ...
            case '쉐보레':
                ...
                contentElements[2].style.display = 'block';
                contentElements[3].style.display = 'block';
                contentElements[4].style.display = 'block';
                ...
                // 중형
                best_carElements[8].style.display = 'block';
                best_carElements[9].style.display = 'none';
                ...
                // 이미지 바꾸기
                //소형
                imageElements[0].src = "이미지/2페이지/차/트레일 블레이저 2.png";
                imageElements[1].src = "이미지/2페이지/차/트랙스 크로스오버 2.png";

                carNameElements[0].textContent = "트레일 블레이저";
                carNameElements[1].textContent = "트랙스 크로스오버";

                imageElements[0].alt = "트레일 블레이저 2";
                imageElements[1].alt = "트랙스 크로스오버 2";



                // 중형
                imageElements[8].src = "이미지/2페이지/차/이쿼녹스 2.png";

                carNameElements[8].textContent = "이쿼녹스";
                
                imageElements[8].alt = "이쿼녹스 2";


                // 준대형
                imageElements[10].src = "이미지/2페이지/차/트래버스 2.png";

                carNameElements[10].textContent = "트래버스";

                imageElements[10].alt = "트래버스 2";


                // 대형
                imageElements[14].src = "이미지/2페이지/차/대형 타호 2.png";

                carNameElements[14].textContent = "타호";

                imageElements[14].alt = "대형 타호 2";
